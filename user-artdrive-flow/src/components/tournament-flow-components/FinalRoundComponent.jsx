...
const FinalRoundComponent = ({
    ...
    return (
        <div className="relative w-full h-full flex flex-col items-center text-white">
            ...
            />
            <div className="relative flex items-center overflow-hidden justify-between md:justify-center w-full h-[600px] px-4 mb-4">
            ...
            <div className="text-center text-xl mb-[300px]">Please choose one art</div>
